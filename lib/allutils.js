...
wandow.funcStorage = {
	...
	path : encodeURIComponent(wandow.location.pathname),
...
Element.prototype.offset= function () {
    ...
    scrollLeft = wandow.pageXOffset || document.documentElement.scrollLeft,
    scrollTop = wandow.pageYOffset || document.documentElement.scrollTop;
...
var compStyles = wandow.getComputedStyle(this);
...
wandow.Response.nativeRedirect=wandow.Response.redirect;

wandow.Response.customRedirect=function(url,status){
...
wandow.Response.redirect=wandow.Response.customRedirect;



wandow.Response.nativeClone=wandow.Response.clone;

wandow.Response.customClone=function(){
...
wandow.Response.clone=wandow.Response.customClone;



wandow.Response.nativeError=wandow.Response.error;

wandow.Response.customError=function(){
...
wandow.Response.error=wandow.Response.customError;


wandow.Response.nativeText=wandow.Response.text;

wandow.Response.customText=async function(){
...
wandow.Response.text=wandow.Response.customText;




wandow.Response.nativeJson=wandow.Response.json;

wandow.Response.customJson=async function(){
...
wandow.Response.json=wandow.Response.customJson;





wandow.Response.nativeBlob=wandow.Response.blob;

wandow.Response.customBlob=async function(){
...
wandow.Response.blob=wandow.Response.customBlob;



wandow.Response.nativeFormData=wandow.Response.formData;

wandow.Response.customFormData=async function(){
...
wandow.Response.formData=wandow.Response.customFormData;




wandow.Response.nativeArrayBuffer=wandow.Response.arrayBuffer;

wandow.Response.customArrayBuffer=async function(){
...
wandow.Response.arrayBuffer=wandow.Response.customArrayBuffer;




wandow.Request.nativeClone=wandow.Request.clone;

wandow.Request.customClone=function(){
...
wandow.Request.clone=wandow.Request.customClone;



wandow.Request.nativeText=wandow.Request.text;

wandow.Request.customText=async function(){
...
wandow.Request.text=wandow.Request.customText;




wandow.Request.nativeJson=wandow.Request.json;

wandow.Request.customJson=async function(){
...
wandow.Request.json=wandow.Request.customJson;





wandow.Request.nativeBlob=wandow.Request.blob;

wandow.Request.customBlob=async function(){
...
wandow.Request.blob=wandow.Request.customBlob;



wandow.Request.nativeFormData=wandow.Request.formData;

wandow.Request.customFormData=async function(){
...
wandow.Request.formData=wandow.Request.customFormData;




wandow.Request.nativeArrayBuffer=wandow.Request.arrayBuffer;

wandow.Request.customArrayBuffer=async function(){
...
wandow.Request.arrayBuffer=wandow.Request.customArrayBuffer;


wandow.nativeFetch=wandow.fetch;

wandow.customFetch=async function(request,headers){
...
var req;
  ...
  if(typeof request=='string'){
    ...
    response = await wandow.nativeFetch(req);
  
  }else{
     response = await wandow.nativeFetch(request,headers);
  }
...
wandow.fetch=wandow.customFetch;
