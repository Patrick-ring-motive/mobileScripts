var documentSource = '<?xml version="1.0" encoding="UTF-8"?><html xmlns="http://www.w3.org/1999/xml"><head></head><body></body></html>';
...
document.createXMLElement = function(tag) {
  ...
  document.getElementById('XMLForge').contentWindow.document.getElementsByTagName('body')[0].innerHTML = '<' + tag + '></' + tag + '>';
  let tg = document.getElementById('XMLForge').contentWindow.document.getElementsByTagName('body')[0].firstElementChild;
