...
document.createMHTMLElement = function(tag) {
  ...
  document.getElementById('MHTMLForge').contentDocument.body.innerHTML = '<' + tag + '></' + tag + '>';
  let tg = document.getElementById('MHTMLForge').contentDocument.body.firstElementChild;
